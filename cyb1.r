...
leftstart: 1950
leftend: 1650
leftstep: -75		; (leftend - leftstart) / 4
rightstart: 700
rightend: 1100
...
doengine: does [
					...
					count: count + 1
					tcount/text: form count
					if all [ysig = 0 robot = 1 (yatt - ymed < 15) (ymed - yatt < 15) ylgam < 2]	
												[;print motorstep
												;print currentpos
												;print motorend
												if any [all [motorstep < 0 currentpos > motorend] all [motorstep > 0 currentpos < motorend]] 														[either mindcount < (mindlevel / 6 ) 		
																		...
																		switch mindlevel [
																		 ...
																		 2 [mindlvlbox2/color: red
																		    show mindlvlbox2]
																		 3 [mindlvlbox2/color: red
																		    show mindlvlbox2
																		 	mindlvlbox1/color: red
																		    show mindlvlbox1
																		 	mindlvlbox3/color: red
																		    show mindlvlbox3
																		    if voice = 1 [insert voiceport "CONTINUEZ"]]
																		 4 [mindlvlbox4/color: red
																			 show mindlvlbox4]
																		 5 [mindlvlbox5/color: red
																			show mindlvlbox5]
																		 6 [mindlvlbox4/color: red
																			 show mindlvlbox4
																		 	mindlvlbox5/color: red
																			show mindlvlbox5
																			 mindlvlbox6/color: red
																			show mindlvlbox6
																			if voice = 1 [insert voiceport "ENCORE"]]
																		 ...
																		 9 [mindlvlbox9/color: red
																			 show mindlvlbox9
																			 mindlvlbox7/color: red
																			show mindlvlbox7
																		 	mindlvlbox8/color: red
																			show mindlvlbox8]
																		 ...
																		 12 [mindlvlbox12/color: red
																			  show mindlvlbox12
																			  mindlvlbox10/color: red
																			 show mindlvlbox10
																		     mindlvlbox11/color: red
																			 show mindlvlbox11
																			 if voice = 1 [insert voiceport "GAGNE"]]
																				]
...
;; Prefs buttons
		...
		at 185x335 sidebtn: choice 70 50.50.50 edge [size: 1x1] "LEFT" "RIGHT"
													...
													case [
														cybside = "LEFT" [status/text: "LEFT -> Motor : #7"
																		  show status
																		  motor: motorleft
																		  motorstart: leftstart
																		  motorend: leftend
																		  motorstep: leftstep
																		  currentpos: leftstart]
														cybside = "RIGHT"  [status/text: "RIGHT -> Motor : #8"
																		  show status
																		  motor: motoright
																		  motorstart: rightstart
																		  motorend: rightend
																		  motorstep: rightstep
																		  currentpos: rightstart]
     ...
     at 185x370 jlivebtn: button 70 50.50.50 edge [size: 1x1] "OSC O/F" [
										either osc <> 1 [
													osc: 1
       												oscport: open/lines tcp://192.168.1.7:13857
	...
	at 20x127 button 70 50.50.50 edge [size: 1x1] "RobON" 	[robot: 1						
															cybrina: open/lines/no-wait tcp://192.168.1.7:13859																		status/text: "Link OK"
															show status
															]														
	at 100x127 button 70 50.50.50 edge [size: 1x1] "OFFline" [robot: 0							
															close cybrina
															if voice = 1 [close voiceport
																			voice: 0]
															]
	at 185x127 button 70 50.50.50 edge [size: 1x1] "Robinit" [status/text: "Initialisation"
															...
															wait 0.5
															insert cybrina "#7 P1950 T500"
															wait 0.5
															insert cybrina "#8 P1950 T500"
															wait 0.5
	...
	at 100x300 button 70 50.50.50 edge [size: 1x1] "Voiceon" [voice: 1
															cybside: form sidebtn/text
															case [
															cybside = "LEFT" [voiceport: open/direct/lines/no-wait tcp://192.168.1.7:13861]
															cybside = "RIGHT" [voiceport: open/direct/lines/no-wait tcp://192.168.1.7:13862]	
															]
															] 
	at 20x300 button 70 50.50.50 edge [size: 1x1] "GameRST" [resetmind
															status/text: "Game reset OK"
															show status
															]
...
readprefs
;check TGC server ?
checktgc: does [testtgc:open/binary/no-wait tcp://192.168.1.7:13854
